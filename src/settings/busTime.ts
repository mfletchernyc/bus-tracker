...
const busTimeStopMonitoringAPI = `${busTimeAPI}/stop-monitoring.json?key=${busTimeAPIKey}&version=2&StopMonitoringDetailLevel=minimum&MaximumStopVisits=3&MonitoringRef=`
